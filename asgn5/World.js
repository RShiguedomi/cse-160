...
function updateAnimationAngles() {
  ...
  if (g_animations) {
    ...
    // let speed = 0.3;
    // t = g_seconds * speed;
    // g_lightPos[0] = radius * Math.cos(t);
    // g_lightPos[2] = radius * Math.sin(t);
    // g_lightPos[1] = 15;
  ...
  let radius = 20;
  let speed = 0.3;
  let t2 = g_seconds * speed;
  g_lightPos[0] = radius * Math.cos(t2);
  g_lightPos[2] = radius * Math.sin(t2);
  g_lightPos[1] = 15;
}
...
function drawCat() {
  ...
  leftForearm.textureNum = uniformTextureNum;
  ...
  leftPaw.textureNum = uniformTextureNum;
  ...
  leftPaw.normalMatrix.setInverseOf(leftPaw.matrix).transpose();
  leftPaw.render();
  ...
  rightForearm.textureNum = uniformTextureNum;
  ...
  rightPaw.textureNum = uniformTextureNum;
  ...
  rightPaw.normalMatrix.setInverseOf(rightPaw.matrix).transpose();
  rightPaw.render();
  ...
  leftHindleg1.textureNum = uniformTextureNum;
  ...
  leftHindleg1.normalMatrix.setInverseOf(leftHindleg1.matrix).transpose();
  leftHindleg1.render();

  var leftHindleg2 = new Cube();
  leftHindleg2.color = uniformColor;
  leftHindleg2.textureNum = uniformTextureNum;
  ...
  leftHindleg2.normalMatrix.setInverseOf(leftHindleg2.matrix).transpose();
  leftHindleg2.render();
  ...
  rightHindleg1.textureNum = uniformTextureNum;
  ...
  rightHindleg1.normalMatrix.setInverseOf(rightHindleg1.matrix).transpose();
  rightHindleg1.render();

  var rightHindleg2 = new Cube();
  rightHindleg2.color = uniformColor;
  rightHindleg2.textureNum = uniformTextureNum;
  ...
  rightHindleg2.normalMatrix.setInverseOf(rightHindleg2.matrix).transpose();
  ...
  leftEye.textureNum = uniformTextureNum;
  ...
  rightEye.textureNum = uniformTextureNum;
  ...
  nose.textureNum = uniformTextureNum;
  ...
  leftEar.textureNum = uniformTextureNum;
  ...
  rightEar.textureNum = uniformTextureNum;
...
function renderAllShapes() {
  ...
  sphere.color = [1,1,0.5,1];
  sphere.textureNum = -2;
  sphere.matrix.translate(g_lightPos[0], g_lightPos[1], g_lightPos[2]);
